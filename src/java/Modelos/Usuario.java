...
public class Usuario {
    ...
    public boolean salvar(){
       String sql = "insert into usuario(nome,cpf,datanasc,fone,email,senha";
              sql += "cep,endereco,bairro,cidade,uf)";
                  sql += "values(?,?,?,?,?,?,?,?,?,?,?)";
       Connection con = Conexao.conectar();
    ...
    public Usuario consultar(int id){
        Connection con = Conexao.conectar();
        String sql = "select id,nome,cpf,datanasc,fone,email,senha,";
               sql += "cep,endereco,bairro,cidade,uf"
    ...
    public List<Usuario> consultar(){
        ...
        String sql = "select id,nome,cpf,datanascimento,fone,email,senha";
               sql += "cep,endereco,bairro,cidade,uf from usuario";
        Usuario usuario = null;
